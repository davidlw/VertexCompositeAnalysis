...
process.mumurerecowrongsign_step = cms.Path( process.eventFilter_HM * process.generalMuMuContinuimOneStTightCandidatesWrongSign * process.generalMuMuContinuimOneStTightPFCandidatesWrongSign * process.generalMuMuContinuimPFCandidatesWrongSign)
...
process.output_HM = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('pPb_HM_MuMu.root'),
...
process.schedule = cms.Schedule(
    ...
    process.mumurereco_step,
    process.mumurerecowrongsign_step,
