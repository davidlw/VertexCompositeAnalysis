...
process.Xipara = cms.EDAnalyzer('HadronCompositeNtupleProducer',
...
HadronCompositeCollection = cms.untracked.InputTag("generalCascadeCandidatesNew:Xi"),
...
process.TFileService = cms.Service("TFileService",
                                       fileName = 
cms.string('Xipara.root')
                                   )


process.p = cms.Path(process.Xipara)
