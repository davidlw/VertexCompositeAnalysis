...
process.generalPhiCandidatesNewWrongSign = process.generalPhiCandidatesNew.clone(isWrongSign = cms.bool(True))
process.phirereco_step = cms.Path( process.eventFilter_HM * process.generalPhiCandidatesNew * process.generalPhiCandidatesNewWrongSign )
...
process.output_HM = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('pPb_HM_Phi.root'),
