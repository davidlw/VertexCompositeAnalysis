...
process.d0selectorNew.GBRForestFileName = cms.string('GBRForestfile_BDT_PromptD0InpPb_default_HLT185_WS_Pt1p5MassPeak_v3.root')
process.npd0selectorNew.GBRForestFileName = cms.string('GBRForestfile_BDT_NonPromptD0InpPb_default_HLT185_WS_Pt1p5MassPeak_v3.root')
process.npd0selector1New.GBRForestFileName = cms.string('GBRForestfile_BDT_NonPromptD0InpPb_default_HLT185_RS_Pt1p5MassPeak_v3.root')
...
process.npd0selectorNewReduced.GBRForestFileName = cms.string('GBRForestfile_BDT_NonPromptD0InpPb_default_HLT185_WS_Pt1p5MassPeak_NoPtErrNHitDLAngle2D_v3.root')
process.npd0selector1NewReduced.GBRForestFileName = cms.string('GBRForestfile_BDT_NonPromptD0InpPb_default_HLT185_RS_Pt1p5MassPeak_NoPtErrNHitDLAngle2D_v3.root')
...
process.d0selectorWSNew.GBRForestFileName = cms.string('GBRForestfile_BDT_PromptD0InpPb_default_HLT185_WS_Pt1p5MassPeak_v3.root')
process.npd0selectorWSNew.GBRForestFileName = cms.string('GBRForestfile_BDT_NonPromptD0InpPb_default_HLT185_WS_Pt1p5MassPeak_v3.root')
process.npd0selectorWS1New.GBRForestFileName = cms.string('GBRForestfile_BDT_NonPromptD0InpPb_default_HLT185_RS_Pt1p5MassPeak_v3.root')
...
process.npd0selectorWSNewReduced.GBRForestFileName = cms.string('GBRForestfile_BDT_NonPromptD0InpPb_default_HLT185_WS_Pt1p5MassPeak_NoPtErrNHitDLAngle2D_v3.root')
process.npd0selectorWS1NewReduced.GBRForestFileName = cms.string('GBRForestfile_BDT_NonPromptD0InpPb_default_HLT185_RS_Pt1p5MassPeak_NoPtErrNHitDLAngle2D_v3.root')
...
process.npd0ana_newreduced = process.npd0ana.clone()
process.npd0ana1_newreduced = process.npd0ana1.clone()
...
process.npd0ana_newreduced.VertexCompositeCollection = cms.untracked.InputTag("npd0selectorNewReduced:D0")
process.npd0ana_newreduced.MVACollection = cms.InputTag("npd0selectorNewReduced:MVAValuesNewD0")
process.npd0ana1_newreduced.VertexCompositeCollection = cms.untracked.InputTag("npd0selector1NewReduced:D0")
process.npd0ana1_newreduced.MVACollection = cms.InputTag("npd0selector1NewReduced:MVAValuesNewD0")
...
process.npd0ana_wrongsign_newreduced = process.npd0ana_wrongsign.clone()
process.npd0ana1_wrongsign_newreduced = process.npd0ana1_wrongsign.clone()
...
process.npd0ana_wrongsign_newreduced.VertexCompositeCollection = cms.untracked.InputTag("npd0selectorWSNewReduced:D0")
process.npd0ana_wrongsign_newreduced.MVACollection = cms.InputTag("npd0selectorWSNewReduced:MVAValuesNewD0")
process.npd0ana1_wrongsign_newreduced.VertexCompositeCollection = cms.untracked.InputTag("npd0selectorWS1NewReduced:D0")
process.npd0ana1_wrongsign_newreduced.MVACollection = cms.InputTag("npd0selectorWS1NewReduced:MVAValuesNewD0")
...
process.npd0ana_seq2 = cms.Sequence(process.eventFilter_HM * process.npd0selectorNewReduced * process.npd0ana_newreduced)
process.npd0ana1_seq2 = cms.Sequence(process.eventFilter_HM * process.npd0selector1NewReduced * process.npd0ana1_newreduced)
...
process.npd0ana_wrongsign_seq2 = cms.Sequence(process.eventFilter_HM * process.npd0selectorWSNewReduced * process.npd0ana_wrongsign_newreduced)
process.npd0ana1_wrongsign_seq2 = cms.Sequence(process.eventFilter_HM * process.npd0selectorWS1NewReduced * process.npd0ana1_wrongsign_newreduced)
