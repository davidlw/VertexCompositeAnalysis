...
process.d0selectorMCNew.GBRForestFileName = cms.string('GBRForestfile_BDT_PromptD0InpPb_default_HLT185_WS_Pt1p5MassPeak_v3.root')
process.npd0selectorMCNew.GBRForestFileName = cms.string('GBRForestfile_BDT_NonPromptD0InpPb_default_HLT185_WS_Pt1p5MassPeak_v3.root')
process.npd0selectorMC1New.GBRForestFileName = cms.string('GBRForestfile_BDT_NonPromptD0InpPb_default_HLT185_RS_Pt1p5MassPeak_v3.root')
...
process.npd0selectorMCNewReduced.GBRForestFileName = cms.string('GBRForestfile_BDT_NonPromptD0InpPb_default_HLT185_WS_Pt1p5MassPeak_NoPtErrNHitDLAngle2D_v3.root')
process.npd0selectorMC1NewReduced.GBRForestFileName = cms.string('GBRForestfile_BDT_NonPromptD0InpPb_default_HLT185_RS_Pt1p5MassPeak_NoPtErrNHitDLAngle2D_v3.root')
...
process.npd0ana_mc_newreduced = process.npd0ana_mc.clone()
process.npd0ana1_mc_newreduced = process.npd0ana1_mc.clone()
...
process.npd0ana_mc_newreduced.VertexCompositeCollection = cms.untracked.InputTag("npd0selectorMCNewReduced:D0")
process.npd0ana_mc_newreduced.MVACollection = cms.InputTag("npd0selectorMCNewReduced:MVAValuesNewD0")
process.npd0ana1_mc_newreduced.VertexCompositeCollection = cms.untracked.InputTag("npd0selectorMC1NewReduced:D0")
process.npd0ana1_mc_newreduced.MVACollection = cms.InputTag("npd0selectorMC1NewReduced:MVAValuesNewD0")
...
process.npd0ana_seq2 = cms.Sequence(process.npd0selectorMCNewReduced * process.npd0ana_mc_newreduced)
process.npd0ana1_seq2 = cms.Sequence(process.npd0selectorMC1NewReduced * process.npd0ana1_mc_newreduced)
