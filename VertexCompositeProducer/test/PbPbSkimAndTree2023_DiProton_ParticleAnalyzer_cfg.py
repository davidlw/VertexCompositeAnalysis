...
#    mass = cms.double(2.0),
    width = cms.double(0.8),
    pdgId = cms.uint32(443),
    preSelection = diPiSelection,
    # daughter information
    daughterInfo = cms.VPSet([
        cms.PSet(pdgId = cms.int32(2112), charge = cms.int32(+1), selection = pionSelection, finalSelection = pionFinalSelection),
        cms.PSet(pdgId = cms.int32(2112), charge = cms.int32(-1), selection = pionSelection, finalSelection = pionFinalSelection),
    ]),
)
...
# Define the output
process.TFileService = cms.Service("TFileService", fileName = cms.string('diproton_ana.root'))
