...
process.colEvtSel = cms.Sequence(process.primaryVertexFilter * process.NoScraping * process.olvFilter_pp5TeV_dz1p0)
...
process.output_HM = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('ppRef_DiMuCont.root'),
