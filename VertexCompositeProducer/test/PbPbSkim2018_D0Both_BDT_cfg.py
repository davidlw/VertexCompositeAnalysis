...
process.generalD0CandidatesNewPromptBDT.useAnyMVA = cms.bool(True)
process.generalD0CandidatesNewPromptBDT.GBRForestFileName = cms.string('GBRForestfile_BDT_PromptD0InpPb_default_HLT185_WS.root')

process.generalD0CandidatesNewNonPromptBDT = process.d0selectorBDTNonPrompt.clone()
process.generalD0CandidatesNewNonPromptBDT.GBRForestFileName = cms.string('GBRForestfile_BDT_NonPromptD0InpPb_default_HLT185_WS.root')

process.d0ana_step = cms.Path(process.eventFilter_HM * process.generalD0CandidatesNewPromptBDT)
process.npd0ana_step = cms.Path(process.eventFilter_HM * process.generalD0CandidatesNewNonPromptBDT)
...
process.output_HM = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('PbPb_HM.root'),
...
#      'keep *_TriggerResults_*_*',
      'keep *_generalD0CandidatesNew*BDT_D0_*',
      'keep *_generalD0CandidatesNew*BDT_MVAValues*_*',
)
