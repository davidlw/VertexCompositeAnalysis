...
config.JobType.psetName = 'pPbSkimAndNtuple2016_DiMuContBoth_mc_cfg.py'
...
for key, val in dataMap.items():
    config.General.requestName = 'VertexCompositeNtuple_'+key+'_pPb816Summer16_DiMuMC_20190522'
