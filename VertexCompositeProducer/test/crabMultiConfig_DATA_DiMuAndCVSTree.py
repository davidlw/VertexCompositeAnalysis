...
config.JobType.psetName = 'pPbSkimAndTree2016_DiMuContBothAndCVS_cfg.py'
...
for key, val in dataMap.items():
    config.General.requestName = 'VertexCompositeTree_'+key+'_PARun2016C_DiMuMassMin2_20190529'
