...
#  addSource    = cms.untracked.bool(False),
  genPdgId     = cms.untracked.vuint32([3122,211,2212]),
...
process.kshortana.genPdgId = cms.untracked.vuint32([310,211,211])
process.xiana.genPdgId = cms.untracked.vuint32([3312,3122,211,2212])
process.omegaana.genPdgId = cms.untracked.vuint32([3334,3122,321,2212])
