...
'root://cmsxrootd.fnal.gov//store/himc/pPb816Summer16DR/PromptD0_D0pT-1p2_pPb-EmbEPOS_8p16_Pythia8/AODSIM/pPbEmb_80X_mcRun2_pA_v4-v1/70000/EE4A348A-CC9D-E711-9738-28924A33AFD2.root'
)
)
...
process.d0ana_mc.doRecoNtuple = cms.untracked.bool(False)
#process.d0ana_mc.MVACollection = cms.InputTag("d0selectorMC:MVAValuesNewD0")

#process.d0selectorMCBDTPreCut.GBRForestFileName = cms.string('')
#process.d0selectorMC = process.d0selectorMCBDTPreCut.clone()

process.d0ana_seq = cms.Sequence(process.d0ana_mc)
