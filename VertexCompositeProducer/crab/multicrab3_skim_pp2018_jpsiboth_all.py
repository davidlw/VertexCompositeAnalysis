...
#    config.JobType.maxJobRuntimeMin = 2750
    config.JobType.psetName = '../test/ppSkim2018_JPsiBoth_cfg.py'
...
#    config.Site.storageSite = 'T2_CH_CERN'
    ...
    config.General.requestName = 'pp2018_Skim_JPsiBoth_default_b1_v1'
    config.Data.inputDataset = '/HighMultiplicityEOF/Run2018B-PromptReco-v2/AOD'
    config.Data.outputDatasetTag = 'pp_Skim_JPsiBoth_default_v1'
    submit(config)

    config.General.requestName = 'pp2018_Skim_JPsiBoth_default_b2_v1'
    config.Data.inputDataset = '/HighMultiplicityEOF/Run2018C-PromptReco-v2/AOD'
    submit(config)

    config.General.requestName = 'pp2018_Skim_JPsiBoth_default_b3_v1'
    config.Data.inputDataset = '/HighMultiplicityEOF0/Run2018C-PromptReco-v2/AOD'
    submit(config)

    config.General.requestName = 'pp2018_Skim_JPsiBoth_default_b4_v1'
    config.Data.inputDataset = '/HighMultiplicityEOF1/Run2018C-PromptReco-v2/AOD'
    submit(config)

    config.General.requestName = 'pp2018_Skim_JPsiBoth_default_b5_v1'
    config.Data.inputDataset = '/HighMultiplicityEOF2/Run2018C-PromptReco-v2/AOD'
    submit(config)

    config.General.requestName = 'pp2018_Skim_JPsiBoth_default_b6_v1'
    config.Data.inputDataset = '/DoubleMuonLowPU/Run2018C-PromptReco-v2/AOD'
    submit(config)

    config.General.requestName = 'pp2018_Skim_JPsiBoth_default_b7_v1'
