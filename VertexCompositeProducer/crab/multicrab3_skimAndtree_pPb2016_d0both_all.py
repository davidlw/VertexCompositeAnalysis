...
#config.JobType.psetName = '../test/pPbSkimAndTree2016_D0Both_BDT_NoPtY_cfg.py'
...
for key, val in dataMap.items():
    config.General.requestName = 'VertexCompositeTree_'+key+'_PARun2016C_D0AndTrackTreeMVA_20190923'
#    config.General.requestName = 'VertexCompositeTree_'+key+'_PARun2016C_D0AndTrackTreeMVA_NoPtY_20190920'
