...
// Class:      D0FitterNew
// 
/**\class D0FitterNew D0FitterNew.h VertexCompositeAnalysis/VertexCompositeProducer/interface/D0FitterNew.h
...
class D0FitterNew {
 public:
  D0FitterNew(const edm::ParameterSet& theParams, edm::ConsumesCollector && iC);
  ~D0FitterNew();
