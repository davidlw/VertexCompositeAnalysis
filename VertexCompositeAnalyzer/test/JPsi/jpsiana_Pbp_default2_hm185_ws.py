...
process.jpsiselector.GBRForestFileName = cms.string('GBRForestfile_BDT_PromptJPsiInpPb_Pbp_default2_HLT185_WS_jpsi.root')
process.jpsiselector.multMin = cms.untracked.double(185)
process.jpsiselector.multMax = cms.untracked.double(250)
process.jpsiselector.trkPMin = cms.untracked.double(3.)
process.jpsiselector.trkPSumMin = cms.untracked.double(8.0)
process.jpsiselector.trkNHitMin = cms.untracked.int32(6)
process.jpsiselector.candVtxProbMin = cms.untracked.double(0.01)
