...
process = cms.Process("ANATREE",eras.Run2_2018)
...
'file:/afs/cern.ch/user/a/anstahll/work/Analysis/Production/CMSSW_10_2_13_patch1/src/VertexCompositeAnalysis/VertexCompositeProducer/test/pp_DiMuCont.root')
)
