...
process.d0selector.GBRForestFileName = cms.string('GBRForestfile_BDT_PromptD0Inpp_default_pphm100_WS.root')
process.d0selector.GBRForestLabel = cms.string('D0Inpp')
process.d0selector.BDTCutFileName = cms.string('BDTCuts_PromptD0_ppHM100.root')
...
process.npd0selector.GBRForestFileName = cms.string('GBRForestfile_BDT_NonPromptD0Inpp_default_pphm100_WS.root')
process.npd0selector.GBRForestLabel = cms.string('D0Inpp')
process.npd0selector.BDTCutFileName = cms.string('BDTCuts_NonPromptD0_ppHM100.root')
