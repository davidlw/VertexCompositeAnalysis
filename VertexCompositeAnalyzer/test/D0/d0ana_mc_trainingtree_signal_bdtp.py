...
process.d0selectorMCBDTPrompt.GBRForestFileName = cms.string('GBRForestfile_BDT_PromptD0InpPb_default_HLT185_WS.root')

process.d0selectorMCGenMatch = process.d0selectorMCBDTPrompt.clone()
process.d0selectorMCGenUnMatch = process.d0selectorMCBDTPrompt.clone()
process.d0selectorMCGenMatchSwap = process.d0selectorMCBDTPrompt.clone()
process.d0selectorMCGenMatchUnSwap = process.d0selectorMCBDTPrompt.clone()
process.d0selectorMCWS = process.d0selectorMCBDTPrompt.clone(
