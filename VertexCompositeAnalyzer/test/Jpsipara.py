...
'root://cms-xrd-global.cern.ch//store/user/davidlw/PAHighMultiplicity1/RecoSkim2016_pPb_JPsi_v1/171213_184104/0000/pPb_HM_JPsi_10.root',
...
'root://cms-xrd-global.cern.ch//store/hidata/PARun2016C/PAHighMultiplicity1/AOD/PromptReco-v1/000/285/505/00000/10288050-8CAF-E611-84A1-FA163EEB21E5.root',
'root://cms-xrd-global.cern.ch//store/hidata/PARun2016C/PAHighMultiplicity1/AOD/PromptReco-v1/000/285/505/00000/829546B0-90AF-E611-8382-FA163E92A1C0.root',
...
process.Jpsipara = cms.EDAnalyzer('VertexCompositeNtupleProducer',
...
HadronCompositeCollection = cms.untracked.InputTag("generalJPsiMuMuOneStTightPFCandidates:JPsiMuMu"),
...
process.TFileService = cms.Service("TFileService",
                                       fileName = 
cms.string('Jpsipara.root')
                                   )


process.p = cms.Path(process.Jpsipara)
