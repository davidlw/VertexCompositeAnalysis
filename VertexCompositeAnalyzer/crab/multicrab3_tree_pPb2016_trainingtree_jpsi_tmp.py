...
#    config.Data.outLFNDirBase = '/store/group/phys_heavyions/flowcorr/'
    ...
    config.General.requestName = 'pPb2016_pPb_Tree_JPsi_training_v2'
    ...
    config.Data.outputDatasetTag = 'pPb_Tree_JPsi_training_HLT185_v2'
    submit(config)

    config.General.requestName = 'pPb2016_Pbp_Tree_JPsi_training_v2'
    config.Data.inputDataset = '/PAHighMultiplicity1/davidlw-Pbp_Skim_JPsiBoth_default_v1-e0e26e1bcab095b6ddfe93551db7333d/USER'
    config.Data.outputDatasetTag = 'Pbp_Tree_JPsi_training_HLT185_v2'
    submit(config)
