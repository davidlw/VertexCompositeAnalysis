...
#    submit(config)
    ...
    config.General.requestName = 'pp2018_D0_BDTCut_default_hm100_ws_histogram_b1_v3'
    config.JobType.psetName = '../test/D0/d0ana_default_pphm100_ws_bdtcut.py'
    config.Data.inputDataset = '/HighMultiplicityEOF/davidlw-pp_Skim_D0Both_default_v1-f9516adb0ab4bcb5c36605171e6520f9/USER'
    config.Data.outputDatasetTag = 'pp2018_D0_BDTCut_default_hm100_ws_histogram_v3'
    submit(config)

    config.General.requestName = 'pp2018_D0_BDTCut_default_hm100_ws_histogram_b2_v3'
    config.Data.inputDataset = '/HighMultiplicityEOF0/davidlw-pp_Skim_D0Both_default_v1-f9516adb0ab4bcb5c36605171e6520f9/USER'
    submit(config)

    config.General.requestName = 'pp2018_D0_BDTCut_default_hm100_ws_histogram_b3_v3'
    config.Data.inputDataset = '/HighMultiplicityEOF1/davidlw-pp_Skim_D0Both_default_v1-f9516adb0ab4bcb5c36605171e6520f9/USER'
    submit(config)

    config.General.requestName = 'pp2018_D0_BDTCut_default_hm100_ws_histogram_b4_v3'
