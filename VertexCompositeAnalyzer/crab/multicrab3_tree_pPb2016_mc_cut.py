...
#    config.JobType.maxJobRuntimeMin = 2750
    config.JobType.psetName = '../test/d0anacut_mc.py'
...
#    config.Site.storageSite = 'T3_US_Rice'
    ...
    config.General.requestName = 'pPb2016_pPb_Tree_D0_Prompt_cut_v1'
    config.Data.outputDatasetTag = 'pPb_Tree_D0_Prompt_cut_v1'
