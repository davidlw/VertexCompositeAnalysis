...
#    config.Data.outLFNDirBase = '/store/user/%s/' % (getUsernameFromSiteDB())
    ...
    config.General.requestName = 'pPb2016_pPb_PromptD0_mva_pT15_24_scenario2_histogram_b1_v2'
    ...
    config.Data.outputDatasetTag = 'pPb_PromptD0_mva_pT15_24_scenario2_histogram_v2'
    submit(config)
