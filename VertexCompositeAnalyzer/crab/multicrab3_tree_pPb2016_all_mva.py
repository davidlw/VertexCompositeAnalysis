...
#    config.Data.outLFNDirBase = '/store/user/%s/' % (getUsernameFromSiteDB())
    ...
    config.General.requestName = 'pPb2016_pPb_D0_BDT_default_hm185_ws_histogram_b1_v7'
...
#    config.Data.inputDataset = '/PAHighMultiplicity1/davidlw-pPb_Skim_D0_v2-89e025b59ba99ac07dd655f3dba5c8df/USER'
    ...
    config.Data.outputDatasetTag = 'pPb_D0_BDT_default_hm185_ws_histogram_dca_v7'
    submit(config)
