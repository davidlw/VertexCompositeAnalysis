...
#    config.Site.storageSite = 'T3_US_Rice'
    ...
    config.General.requestName = 'pPb2016_pPbMC_PromptD0_histograms_v1'
    config.Data.outputDatasetTag = 'pPb_histograms_v1'
    ...
    config.JobType.psetName = '../test/d0ana_mc_histograms.py'
    submit(config)

#    config.General.requestName = 'pPb2016_pPbMC_NonPromptD0_histograms_v1'
#    config.Data.outputDatasetTag = 'pPb_histograms_v1'
