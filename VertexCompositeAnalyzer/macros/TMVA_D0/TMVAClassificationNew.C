...
//    factory->AddVariable( "normalizedChi2Daugther1", 'F' );
//    factory->AddVariable( "normalizedChi2Daugther2", 'F' );

   // You can add so-called "Spectator variables", which are not used in the MVA training,
   // but will appear in the final "TestTree" produced by TMVA. This TestTree will contain the
   // input variables, the response values of all trained MVAs, and the spectator variables

//   factory->AddSpectator( "pTD1+pTD2",  "pTD1+pTD2", "", 'F' );
//   factory->AddSpectator( "abs(EtaD1-EtaD2)",  "abs(EtaD1-EtaD2)", "", 'F' );
//   factory->AddSpectator( "NHitD1",  "NHitD1", "", 'F' );
//   factory->AddSpectator( "NHitD2",  "NHitD2", "", 'F' );
//   factory->AddSpectator( "pTerrD1",  "pTerrD1", "", 'F' );
//   factory->AddSpectator( "pTerrD2",  "pTerrD2", "", 'F' );
...
//   TFile *input_background = TFile::Open("training_samples/d0ana_training_57.root");
   ...
   std::cout << "--- TMVAClassification       : Using signal input file: " << input_signal->GetName() << std::endl;
...
//                                        "nTrain_Signal=50000,nTrain_Background=50000,nTest_Signal=50000,nTest_Background=50000,SplitMode=Random:!V");
   ...
   if (Use["BDTG"]) // Gradient Boost
      factory->BookMethod( TMVA::Types::kBDT, "BDTG",
                           "!H:!V:NTrees=300:MinNodeSize=2.5%:BoostType=Grad:Shrinkage=0.10:UseBaggedBoost:BaggedSampleFraction=0.5:nCuts=20:MaxDepth=2" );
